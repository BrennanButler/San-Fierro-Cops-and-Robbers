		...
		<body>
			...
			<div class="container">
				...
				<div class="page-title">
					...
					<h1>Example Blog - Chicken</h1>
					<h4 class="text-right"><a href="">Home</a> / Blog / Example blog - Chicken</h4>
				</div>
				<div class="normal-page">
					...
					<div class="inner-page">
						<div class="inner-container">
							...
							<div class="content">
								<p>This is an example. This is what a blog page would look like.</p>
								<h1 class="blog-title">Chicken</h1>
								...
								<a href="http://img3.wikia.nocookie.net/__cb20130606165306/animalcrossing/images/4/41/Chicken.jpg"><img src="http://img3.wikia.nocookie.net/__cb20130606165306/animalcrossing/images/4/41/Chicken.jpg" alt="chicken" width="200"/></a>
								<p class="blog-auth">- This post was created by <a href="#">thefatshizms</a></p>
							</div>
